...
var DatePicker = (function () {
    ...
    DatePicker.prototype.createDateSelectorElement = function (visibleDate) {
        ...
        var monthSelectorElement = Button.getModule({ id: this.id + '-callendar-month-prev', type: "minimal", iconClass: "fa fa-chevron-left" }) + "<span>" + monthNames[visibleDate.month - 1] + "</span>" + Button.getModule({ id: this.id + '-callendar-month-next', type: "minimal", iconClass: "fa fa-chevron-right" });
        var yearSelectorElement = Button.getModule({ id: this.id + '-callendar-year-prev', type: "minimal", iconClass: "fa fa-chevron-left" }) + "<span>" + visibleDate.year + "</span>" + Button.getModule({ id: this.id + '-callendar-year-next', type: "minimal", iconClass: "fa fa-chevron-right" });
    ...
    DatePicker.prototype.createModuleElement = function () {
        ...
        if (this.type == 'date' || this.type == 'datetime') {
            ...
            var monthElement = this.createMonthElement(this.selectedDate, this.activeDate, this.visibleDate);
