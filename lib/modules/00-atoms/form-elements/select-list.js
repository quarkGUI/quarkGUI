    ...
    SelectList.prototype.addListener = function (selectList, inputField, dropdownList) {
        document.addEventListener('DOMContentLoaded', function (e) {
            ...
            if (selectListElementIsDefined && inputFieldElementIsDefined && dropdownListElementIsDefined) {
                var selectListElement = document.getElementById(selectList.id);
                ...
                var labelElementIsDefined = selectList.elementIsNotNullOrUndefinedByTagName(selectListElement, "LABEL");
                if (labelElementIsDefined) {
                    var labelElementList = selectListElement.getElementsByTagName("LABEL");
