...
var SelectList = (function () {
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            ...
            if (selectListElementIsDefined && inputFieldElementIsDefined && dropdownListElementIsDefined) {
                ...
                inputFieldElement_1.onfocus = function () {
                    if (!inputFieldElement_1.readOnly) {
    ...
    SelectList.prototype.createModuleElement = function () {
        ...
        var readOnlyClass = this.attributes !== undefined && this.attributes.indexOf('readonly') > -1 ? Style.readOnly : '';
        var disabledClass = this.attributes !== undefined && this.attributes.indexOf('disabled') > -1 ? Style.disabled : '';
