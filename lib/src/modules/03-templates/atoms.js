...
const InputField = require("../00-atoms/form-elements/input-field");
const SelectList = require("../00-atoms/form-elements/select-list");
const Checkbox = require("../00-atoms/form-elements/checkbox");
const RadioButton = require("../00-atoms/form-elements/radio-button");
const DatePicker = require("../00-atoms/form-elements/date-picker");
function default_1() {
    return ` 
			<h2>Buttons</h2>
